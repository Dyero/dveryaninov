...
window.DVERYANINOV_CFG = (function () {
  ...
  var SIZES = [
    ...
    "2000×680","2000×690","2000×700","2000×780","2000×790","2000×800",
    "Свой размер"
  ];
  ...
  var DOBOR = {
    pvh: [
      { name: "Добор телескопический 100", spec: "комплект 3 шт", price: 2880 },
      { name: "Добор телескопический 150", spec: "комплект 3 шт", price: 3960 },
      { name: "Добор телескопический 200", spec: "комплект 3 шт", price: 4890 },
      { name: "Добор телескопический со своим размером", spec: "комплект 3 шт, цена по запросу", price: 0, priceRequest: true },
      { name: "Без добора", price: 0 }
    ],
    enamel: [
      { name: "Добор телескопический 100", spec: "комплект 3 шт", price: 4620 },
      { name: "Добор телескопический 150", spec: "комплект 3 шт", price: 6930 },
      { name: "Добор телескопический 200", spec: "комплект 3 шт", price: 9240 },
      { name: "Добор телескопический со своим размером", spec: "комплект 3 шт, цена по запросу", price: 0, priceRequest: true },
      { name: "Без добора", price: 0 }
    ]
  };
