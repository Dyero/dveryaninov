...
$APPLICATION->SetPageProperty("description", "Премиальные двери от производителя Дверянинов. Собственное производство, экологичные материалы, контроль качества.");
?>
...
<main class="about-page">
    ...
    <div class="about-banner">
        <img class="about-banner__image" src="<?= SITE_TEMPLATE_PATH ?>/images/hero-bg.svg" alt="" width="1920" height="500">
    </div>
    ...
    <section class="about-block about-block_image-right">
        ...
        <div class="about-block__image-wrap">
            <img class="about-block__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-1.png" alt="Сервис компании" width="560" height="380">
        </div>
    </section>
    ...
    <section class="about-block about-block_alt about-block_image-left">
        ...
        <div class="about-block__image-wrap">
            <img class="about-block__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-2.png" alt="Индивидуальные размеры" width="560" height="380">
        </div>
    </section>
    ...
    <section class="about-block about-block_image-right">
        ...
        <div class="about-block__image-wrap">
            <img class="about-block__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-3.png" alt="Производство" width="560" height="380">
        </div>
    </section>
    ...
    <section class="about-block about-block_alt about-block_image-left">
        ...
        <div class="about-block__image-wrap">
            <img class="about-block__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-4.png" alt="Экологичные материалы" width="560" height="380">
        </div>
    </section>
    ...
    <section class="about-quality">
        ...
        <div class="about-quality__content">
            ...
            <p class="about-quality__intro">
                Эффективная система контроля качества продукции на четырёх этапах производства:
            </p>
        ...
        <div class="about-certs__grid">
            <div class="cert-card">
                <div class="cert-card__image-wrap">
                    <img class="cert-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/card-door-1.svg" alt="Сертификат ГОСТ" width="200" height="280">
                </div>
                <p class="cert-card__label">Сертификат ГОСТ Р</p>
            </div>
            <div class="cert-card">
                <div class="cert-card__image-wrap">
                    <img class="cert-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/card-door-2.svg" alt="Пожарная безопасность" width="200" height="280">
                </div>
                <p class="cert-card__label">Пожарная безопасность</p>
            </div>
            <div class="cert-card">
                <div class="cert-card__image-wrap">
                    <img class="cert-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/card-door-3.svg" alt="Экологический сертификат" width="200" height="280">
                </div>
                <p class="cert-card__label">Эко-сертификат</p>
            </div>
            <div class="cert-card">
                <div class="cert-card__image-wrap">
                    <img class="cert-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/card-door-4.svg" alt="Звукоизоляция" width="200" height="280">
                </div>
    ...
    <section class="about-news">
        ...
        <div class="about-news__grid">
            <article class="about-news-card">
                <img class="about-news-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-1.png" alt="Новость" width="440" height="280">
                <div class="about-news-card__body">
                    <span class="about-news-card__date">16.09.2022</span>
                    <h3 class="about-news-card__title">Открытие нового шоурума в Чебоксарах</h3>
                </div>
            </article>
            <article class="about-news-card">
                <img class="about-news-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-2.png" alt="Новость" width="440" height="280">
                <div class="about-news-card__body">
                    <span class="about-news-card__date">05.07.2022</span>
                    <h3 class="about-news-card__title">Коллекция MILLENNIUM в натуральном шпоне</h3>
                </div>
            </article>
            <article class="about-news-card">
                <img class="about-news-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-3.png" alt="Новость" width="440" height="280">
                <div class="about-news-card__body">
                    <span class="about-news-card__date">12.03.2022</span>
                    <h3 class="about-news-card__title">Расширение ассортимента скрытых дверей</h3>
                </div>
            </article>
            <article class="about-news-card">
                <img class="about-news-card__image" src="<?= SITE_TEMPLATE_PATH ?>/images/news-4.png" alt="Новость" width="440" height="280">
                <div class="about-news-card__body">
                    <span class="about-news-card__date">18.01.2022</span>
                    <h3 class="about-news-card__title">Дверянинов — лауреат премии «Лучший производитель»</h3>
                </div>
            </article>
        </div>
    </section>
