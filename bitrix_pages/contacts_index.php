...
$APPLICATION->SetPageProperty("description", "Контакты компании Дверянинов. Телефон, адрес офиса и шоурума в Новочебоксарске.");
?>
    ...
    <section class="map-module" aria-label="Карта и точки продаж">
        <div class="map-module__grid">
            ...
            <div class="map-module__map" aria-label="Карта">
                <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A8b3ba775eb6c9393103d98610a836324133782df260789901a3c724aeb6d050a&amp;width=600&amp;height=400&amp;lang=ru_RU&amp;scroll=true"></script>
            </div>
        </div>
    </section>
</main>
